...
class TicketServiceTest {
    ...
    @DirtiesContext(methodMode = DirtiesContext.MethodMode.AFTER_METHOD)
    @Test
    fun `create issue with an unauthorized customer`() {
        ...
        val responseCreateIssue = restTemplate.exchange(
            ...
            ProblemDetail::class.java)
        Assertions.assertEquals(HttpStatus.UNAUTHORIZED, responseCreateIssue.statusCode)
    ...
    @DirtiesContext(methodMode = DirtiesContext.MethodMode.AFTER_METHOD)
    @Test
    fun `start progress with an unauthorized manager`(){
        ...
        Assertions.assertEquals(HttpStatus.UNAUTHORIZED, responseStartProgress.statusCode)
    ...
    @DirtiesContext(methodMode = DirtiesContext.MethodMode.AFTER_METHOD)
    @Test
    fun `stop progress by un unauthorized Manager`(){
        ...
        Assertions.assertEquals(HttpStatus.UNAUTHORIZED, responseStopProgress.statusCode)
    ...
    @DirtiesContext(methodMode = DirtiesContext.MethodMode.AFTER_METHOD)
    @Test
    fun `stop progress by an unauthorized Expert`(){
    ...
    @DirtiesContext(methodMode = DirtiesContext.MethodMode.AFTER_METHOD)
    @Test
    fun `resolve issue by an unauthorized Client`(){
        ...
        Assertions.assertEquals(HttpStatus.UNAUTHORIZED, responseResolveIssue.statusCode)

    }

    @DirtiesContext(methodMode = DirtiesContext.MethodMode.AFTER_METHOD)
    @Test
    fun `resolve issue by an unauthorized Expert`(){
    ...
    @DirtiesContext(methodMode = DirtiesContext.MethodMode.AFTER_METHOD)
    @Test
    fun `close issue by an unauthorized Expert`(){
        ...
        Assertions.assertEquals(HttpStatus.UNAUTHORIZED, responseCloseIssue.statusCode)
    ...
    @DirtiesContext(methodMode = DirtiesContext.MethodMode.AFTER_METHOD)
    @Test
    fun `reopen issue by an unauthorized Client`(){
        ...
        val responseReopenIssue = restTemplate.exchange(
            ...
            TicketDTO::class.java)
        Assertions.assertEquals(HttpStatus.UNAUTHORIZED, responseReopenIssue.statusCode)
